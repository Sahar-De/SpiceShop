            ...
            <div className='flex flex-col laptop:flex-row gap-y-5 gap-x-14 p-6'>
                <div className='flex flex-col gap-y-5 laptop:flex-row w-full  laptop:w-2/3 gap-x-14'>
                    <div className='flex flex-col gap-2 items-start'>
                        ...
                        <p>تیم مجرب ما به شما کمک می‌کند تا یک فضای زیبا و آرامش‌بخش در حیاط و باغ خود ایجاد کنید.</p>
                    </div>
                    <div className='flex flex-col gap-2 items-start'>
                ...
                <div className='newsLetters flex flex-col justify-center gap-4 w-full laptop:w-1/3'>
                    ...
                    <p className='text-dark text-xs'>
                        ما معمولا پیشنهادات و چالش ها را در خبرنامه ارسال می کنیم. ما مقصد آنلاین گیاهان آپارتمانی شما هستیم. ما طیف گسترده ای از گیاهان آپارتمانی و لوازم جانبی را ارائه می دهیم که مستقیماً از خانه (سبز) ما به خانه شما ارسال می شود!
                    </p>
                </div>
            </div>
